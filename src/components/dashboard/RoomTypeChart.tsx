...
export function RoomTypeChart({ rooms }: RoomTypeChartProps) {
  // Calculate room type distribution from real data
    ...
    <div className="rounded-xl border border-border bg-card p-6 animate-fade-in">
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          {rooms.length > 0 ? 'By room type' : 'No rooms configured'}
        </p>
      </div>
